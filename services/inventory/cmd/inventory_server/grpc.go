...
import (
	...
	inventorysvr "gaucho/services/inventory/gen/grpc/inventory/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, inventoryEndpoints *inventory.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
