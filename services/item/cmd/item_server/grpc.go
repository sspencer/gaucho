...
import (
	...
	itemsvr "gaucho/services/item/gen/grpc/item/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, itemEndpoints *item.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
