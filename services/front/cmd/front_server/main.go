...
import (
	...
	"flag"
	"fmt"
	characterapi "gaucho/services/character"
	frontapi "gaucho/services/front"
	front "gaucho/services/front/gen/front"
	inventoryapi "gaucho/services/inventory"
	itemapi "gaucho/services/item"
	"log"
	"net"
	"net/url"
	"os"
...
func main() {
	...
	{
		frontSvc = frontapi.NewFront(
			logger,
			characterapi.NewCharacter(log.New(os.Stderr, "[character] ", log.Ltime)),
			itemapi.NewItem(log.New(os.Stderr, "[item] ", log.Ltime)),
			inventoryapi.NewInventory(log.New(os.Stderr, "[inventory] ", log.Ltime)),
		)
	}
