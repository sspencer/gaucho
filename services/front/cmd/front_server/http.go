...
import (
	...
	frontsvr "gaucho/services/front/gen/http/front/server"
	"log"
	"net/http"
	"net/url"
	"os"
...
func handleHTTPServer(ctx context.Context, u *url.URL, frontEndpoints *front.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
